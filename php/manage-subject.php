        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"data-toggle="modal" data-target="#modal-subject" class="btn btn-primary">Add Subject</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            $quary = "SELECT * FROM `subjects` ";
              $result = $con -> query($quary);
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<tr><td>$id</td><td>$subject</td><td>$status</td><td><a class='btn btn-info btn-sm' href=?id=$id data-toggle='modal' data-target='#modal-update-subject'><i class='fa fa-edit'></i></a> &nbsp &nbsp <a class='btn btn-danger btn-sm' href='delete-subject?id=$id'><i class='fa fa-trash'></i></a></td></tr>";
                }
